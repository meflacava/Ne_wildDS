...
##    1. "list" of fastq files to align to reference genome FMT == [ R1 | R2 | prefix ]
##    2. reference fasta file to align to
...
# make index for reference genome [ML commented out because previously done]
## get shortened name
...
#cat << readme >> ${out}/README #ML commented out
